...
var metaData = {
    ...
    "APIURL" : apiurl,
    "APPKEY" : appkey,
    "VIEWSURL" : protocol+'://sview.'+domain+port,
    "SITEPORT" : (protocol=="http"?9999:9998),
    "HTTP": protocol+"://",
    "SITES": '{"swww.'+domain+port+'":"www","sglobal.'+domain+port+'":"global","sm.'+domain+port+'":"m","sview.'+domain+port+'":""}',
    "VIEWSSITE": 'sview.'+domain+port,
